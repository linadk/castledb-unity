...
namespace CompiledTypes.OtherDB
{
    public class OtherDB
    {
        ...
        {
           public Creatures Squid { get { return Get(CompiledTypes.OtherDB.Creatures.RowValues.Squid); } } 
           public Creatures Jellyfish { get { return Get(CompiledTypes.OtherDB.Creatures.RowValues.Jellyfish); } } 
           public Creatures Bear { get { return Get(CompiledTypes.OtherDB.Creatures.RowValues.Bear); } } 
           public Creatures Dragon { get { return Get(CompiledTypes.OtherDB.Creatures.RowValues.Dragon); } } 
        ...
        {
           public Items HealingPotion { get { return Get(CompiledTypes.OtherDB.Items.RowValues.HealingPotion); } } 
           public Items PoisonPotion { get { return Get(CompiledTypes.OtherDB.Items.RowValues.PoisonPotion); } } 
           public Items UltraSword { get { return Get(CompiledTypes.OtherDB.Items.RowValues.UltraSword); } } 
        ...
        {
           public Modifiers poison { get { return Get(CompiledTypes.OtherDB.Modifiers.RowValues.poison); } } 
           public Modifiers enchanted { get { return Get(CompiledTypes.OtherDB.Modifiers.RowValues.enchanted); } } 
        ...
        public OtherDB(TextAsset castleDBAsset)
        {
