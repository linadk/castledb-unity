...
{ 
    public class Creatures
    {
        ...
        public DeathSoundEnum DeathSound;public enum DeathSoundEnum {  Sound1 = 0,Sound2 = 1 }
        public Spawn_AreasFlag Spawn_Areas;[FlagsAttribute] public enum Spawn_AreasFlag { Forest = 1,Mountains = 2,Lake = 4,Plains = 8 }
        public Color Color;
        public Texture Icon;

        public enum RowValues {Squid , Jellyfish , Bear , Dragon }
